   ...
   BEGIN
      ...
      THEN
         ...
         LOOP
            ...
            v_tronco_telefone          := RPAD (NVL (TRIM (reg_gvt_cadastro_cliente.tronco_telefone), '0'), 8, '0');
            ...
            v_linha_detalhe            :=
               ...
               ||   --TIPO TERMINAL
                  -- acesso a telefonia
                  TRIM (TO_CHAR (NVL (reg_gvt_cadastro_cliente.linha_cnl, 0), '00009'))
               || TRIM (TO_CHAR (NVL (reg_gvt_cadastro_cliente.linha_ddd, 0), '09'))
               || RPAD (NVL (TRIM (reg_gvt_cadastro_cliente.linha_telefone), ' '), 8, ' ')
               ||
               ...
               || RPAD (NVL (reg_gvt_cadastro_cliente.contato_telefone, ' '), 8, ' ')
               ||
               ...
               || RPAD (NVL (reg_gvt_cadastro_cliente.telefone_ant_telefone, ' '), 8, ' ')
      ...
      ELSE
         ...
         LOOP
            ...
            v_tronco_telefone          := RPAD (NVL (TRIM (reg_gvt_cadastro_cliente_2.tronco_telefone), '0'), 8, '0');
            ...
            v_linha_detalhe            :=
               ...
               || RPAD (NVL (TRIM (reg_gvt_cadastro_cliente_2.linha_telefone), ' '), 8, ' ')
               ||
                  --acesso a tronco chave
                  v_tronco_cnl
               || v_tronco_ddd
               ...
               || RPAD (NVL (reg_gvt_cadastro_cliente_2.contato_telefone, ' '), 8, ' ')
               ||
                  -- suspensao a pedido do cliente
                  v_ind_susp
               ...
               || RPAD (NVL (reg_gvt_cadastro_cliente_2.telefone_ant_telefone, ' '), 8, ' ')
