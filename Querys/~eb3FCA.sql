...
select * from bmf where account_no = 2508754 and orig_bill_ref_no = 97676091
...
select ci.external_id conta,
                      ...
                      from  g0007405sql.banrisul_lbx_pgto_outros b, 
                            cmf_balance c, 
...
select G.account_no,
 ...
 where B.ACCOUNT_NO = G.ACCOUNT_NO
   ...
   and G.external_id in ('999985180922','999985565819','999987077251','999987756342','999988319670','999989393026','999989498156','999989517477','999990535694','999990791857')
