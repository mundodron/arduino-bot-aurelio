...
DECLARE
   V_ESN          TBTTPFLPRQ.TEXTO%TYPE;
   V_NTC_CANC     TBTTPFLPRQ.TEXTO%TYPE;
   V_NTC_HABIL    TBTTPFLPRQ.TEXTO%TYPE;
   V_CD_REV_C     TBTTPFLPRQ.TEXTO%TYPE;
   V_CD_REV_I     TBTTPFLPRQ.TEXTO%TYPE;
   V_DTATV_C      TBTTPFLPRQ.TEXTO%TYPE;
   V_DTATV_I      TBTTPFLPRQ.TEXTO%TYPE;
...
WHERE 1 =1 --service.parent_ACCOUNT_NO in (select account_no from customer_id_acct_map where external_id in ('999979767269'))
...
BEGIN   
  FOR REG_C1 IN C1 LOOP
   ...
   INSERT INTO GVT_FEBRABAN_PONTA_B_ARBOR (QUERY_ID, TEXT1,             TEXT2,        TEXT3,       TEXT4, TEXT5,      TEXT6,       TEXT7,      TEXT8,      TEXT9,     TEXT10)
           VALUES          (373,      REG_C1.CONTACTID,  REG_C1.CRUSR, REG_C1.CRDT, V_ESN, V_NTC_CANC, V_NTC_HABIL, V_CD_REV_C, V_CD_REV_I, V_DTATV_C, V_DTATV_I);        
