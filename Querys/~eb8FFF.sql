...
from bill_invoice
where prep_Date between to_date('01/04/2014 00:00:00','dd/mm/yyyy hh24:mi:ss') and to_date('30/04/2014 23:59:59','dd/mm/yyyy hh24:mi:ss')
  and prep_status=1
  and bill_period = 'M20'
...
drop table g0023421sql.gvt_fat_sempre_temp;

create table g0023421sql.gvt_fat_sempre_temp as 
select distinct a.* 
...
from cdr_data a,cdr_billed b,g0023421sql.gvt_fat_sempre_temp c
