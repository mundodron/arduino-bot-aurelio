    SELECT   
       ...
       WHERE   SERVICE_ADDRESS_ASSOC.address_id = LOCAL_ADDRESS.address_id
               ...
               AND   q.ASSET_NUM in ('RJO-30S1A8KD-9592-30S1A8KF','SGO-301D8K81U-9592-301D8K81T','SGO-30S1488F-9592-30S1488H')
               ...
               select * from customer_id_equip_map where external_id = 'RJO-30S1A8KD-9592-30S1A8KF'
               
               select * 
                 from S_QUOTE_SOLN q,
                      customer_id_equip_map 
                where ASSET_NUM in ('RJO-30S1A8KD-9592-30S1A8KF','SGO-301D8K81U-9592-301D8K81T','SGO-30S1488F-9592-30S1488H')
                  and COPIED_FLG = 'N'