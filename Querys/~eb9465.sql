...
select map.external_id            "CONTA_COBRANCA",
 ...
 where inactive_date is null
   ...
   --and BILL.BILL_REF_NO = 179362302
...
select map.external_id            "CONTA_COBRANCA",
 ...
 where inactive_date is null
   ...
   --and EXISTS (SELECT 1 FROM cmf WHERE CMF.ACCOUNT_NO = MAP.ACCOUNT_NO and CMF.ACCOUNT_CATEGORY in (10,11))
   and DET.SUBTYPE_CODE in (12500, 12501)
   and BILL.BILL_REF_NO = 178753769
   ...
   select * from bill_invoice where account_no = 7563523 and prep_status = 4
   
   select * from bill_invoice_detail where bill_ref_no = 178753769
