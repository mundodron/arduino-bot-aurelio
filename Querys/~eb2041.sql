...
FROM CUSTOMER_ID_EQUIP_MAP EIEM,
     ...
     S_QUOTE_SOLN Q
WHERE service.parent_ACCOUNT_NO in (select account_no from customer_id_acct_map where external_id in ('999999234617'))
...
AND   Q.ASSET_NUM in ('CTA-30RTO2GC-013','CTA-30TKCPU3-013');
