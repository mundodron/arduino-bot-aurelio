...
and months_between(to_date(sysdate, 'dd/mm/yyyy'),to_date(gdgfe.dt_evento, 'dd/mm/yyyy')) <= 3
AND TRUNC(gdgfe.dt_evento) >= TO_dATE('01/02/2012','DD/MM/YYYY')
AND TRUNC(gdgfe.dt_evento) <= TO_dATE('21/05/2012','DD/MM/YYYY')
