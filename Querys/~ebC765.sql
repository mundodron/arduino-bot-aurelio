...
WHERE 1=1 --service.parent_ACCOUNT_NO in (select account_no from customer_id_acct_map where external_id in ('999990543589'))
...
select *
 ...
 where e.external_id in ('999990543589')
   and A.ACCOUNT_NO = S.PARENT_ACCOUNT_NO
   and S.SUBSCR_NO = E.SUBSCR_NO

select * from customer_id_acct_map where external_id = ('999990543589')

select * from service where parent_account_no = 2332273
