    --EXEC SQL AT :CONNECTION->db_name DECLARE read_equip_detail_recs CURSOR FOR
      SELECT 
             ...
             c.description_febraban, d.open_item_id,      rpad(spr.amex_descriptor,19, ' '),     c.COD_CATEGORIA, c.SHORT_DESCRIPTION_TEXT, U.POINT_ID, d.point_id_target, b.msg_id,  b.msg_id2, b.msg_id_serv
      ...
      WHERE  b.bill_ref_no           =  231921369 -- :p_bill_ref_no
        ...
        --and  D.COUNTRY_CODE_TARGET   = U.COUNTRY_CODE
        --and  D.COUNTRY_CODE_ORIGIN   = U1.COUNTRY_CODE(+)
