...
and upper(nome_arquivo) like '%ABRIL%'
and DATA_PROCESSAMENTO > sysdate - 100
...
select * from cmf_balance where bill_ref_no in ('999980014348','999991682921','999991682930','999991682926','999991316826')
...
select * from GVT_CONTA_INTERNET where account_no in (7374426,2013184,1966093,1964951,1964851) and data_processamento > sysdate - 50;

delete GVT_CONTA_INTERNET where account_no in (7374426,2013184,1966093,1964951,1964851) and data_processamento > sysdate - 50;
