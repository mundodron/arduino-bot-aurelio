select C.EXTERNAL_ID,
 ...
 where A.ACCOUNT_NO = C.ACCOUNT_NO
   ...
   and C.EXTERNAL_ID in ('999979723285')
   --and C.ACCOUNT_NO = 3847517
 order by 4 desc;
 
select * from gvt_cease_account where serv_inst='MGA-104LZ8I4-003-104LZ8IF';

select * from cmf_exempt where account_no in (select account_no from customer_id_acct_map where external_id = '999994249897')
