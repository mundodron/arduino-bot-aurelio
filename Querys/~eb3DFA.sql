...
WHERE CIAM.EXTERNAL_ID IN ('899997760911','899996660745','899997179769','899997760911','899999626707')
   ...
   select * from bill_invoice where account_no = 9126292
   
   update cmf set CUST_STATE = 'RN' where account_no = 9564079;
   
   update cmf set CUST_STATE = 'CE' where account_no = 9950983;
