...
------------------------------------------
  ...
  v_seq_numb             NUMBER(6);
  v_bank_seqs             VARCHAR2 (50) := 'DBAREM_DB2CT1.bankseqs'; -- SELECT 'DBAREM_' || GLOBAL_NAME || '.bankseqs' FROM GLOBAL_NAME;
...
-- v_bankseqs := SELECT 'DBAREM_' || GLOBAL_NAME || '.bankseqs' FROM GLOBAL_NAME;
