...
FROM CUSTOMER_ID_EQUIP_MAP EIEM,
     ...
     S_QUOTE_SOLN Q
WHERE service.parent_ACCOUNT_NO in (select account_no from customer_id_acct_map where external_id in ('999982439335'))
...
and   EIEM.EXTERNAL_ID in ('CTA-3015SO1GQ-9699-3015SO1GZ')--,'CTA-3015SO1HX','CTA-3015SO1HX-9699-3015SO1I6','CTA-3015SO1J4','CTA-3015SO1J4-9699-3015SO1JD','CTA-3015SO1KB','CTA-3015SO1KB-9699-3015SO1KK','CTA-3019MMUN9','CTA-3019MMUN9-9699-3019MMUNB','CTA-3019MSLZU','CTA-3019MSLZU-9699-3019MSLZW');
...
select * from GVT_FEBRABAN_PONTA_B_ARBOR where EMF_EXT_ID in ('CTA-3015SO1J4-9699-3015SO1JD')
