...
WHERE 1 =1 --SERVICE.PARENT_ACCOUNT_NO in (select account_no from customer_id_acct_map where external_id in ('999998789836'))
...
select * from customer_id_acct_map where external_id = '999998789836'
