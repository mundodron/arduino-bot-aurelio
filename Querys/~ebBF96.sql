...
FROM CUSTOMER_ID_EQUIP_MAP EIEM,
     ...
     S_QUOTE_SOLN Q
WHERE /*service.parent_ACCOUNT_NO in (select account_no from GVT_FEBRABAN_ACCOUNTS where external_id in  ('999985081749','999985081748','999983129627','999985081815','999983680795','999985081811','999985081812','999985081813')
...
AND   A.EXTERNAL_ID in ('999991376205','999983795899','999989190542','999989139256','999992667115','999989388562','999987071964','999992108848','999985388343') 
...
select Q.ROW_ID, A.EXTERNAL_ID as CMF_EXT_ID, C.EXTERNAL_ID as EMF_EXT_ID, A.ACCOUNT_NO, 
 ...
 where A.ACCOUNT_NO = S.PARENT_ACCOUNT_NO
   ...
   select * from bill_invoice_detail where bill_ref_no = 114147316