  ...
  IF(v_data_aberturaAuxiliar IS NOT NULL) THEN
    ...
    BEGIN
      INSERT INTO arborgvt_billing.gvt_credito_interrupcao_log (
            external_id,     dt_abertura,     dt_fechamento,   num_ss,   desc_ss,   tipo_produto, dt_inclusao, flag_processado, mensagem                                                 , valor_produto, valor_ressarc, SUBSCR_NO, SUBSCR_NO_RESETS)
      VALUES (
          v_external_id, v_data_abertura, v_data_fechamento, v_num_ss, v_desc_ss, v_tipo_produto, SYSDATE    , 8              , 'Relacionado mesma origem - '||v_num_ss_auxiliar_abertura,             0,             0, null     , null);
