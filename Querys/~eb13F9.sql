      ...
      FROM   BILL_INVOICE_DETAIL b,  CUSTOMER_ID_ACCT_MAP c, SERVICE s, CUSTOMER_ID_EQUIP_MAP m, 
             PRODUCT_LINES p, DISCOUNT_DEFINITIONS d, GVT_PRODUCT_VELOCITY gp, GVT_BILL_PRODUCT_RATE_KEY r
      WHERE  b.bill_ref_no           = 295118302
