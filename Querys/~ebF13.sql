...
begin
    ...
    for c1 in C_FATURA loop
        for c2 in C_BUSCA_DUPLICIDADE(c1.bill_ref_no, c1.SUBSCR_NO) loop
            dbms_output.put_line('C2 Duplicidade' ||';'|| c1.EXTERNAL_ID ||';'|| c1.account_no ||';'|| c1.SUBSCR_NO ||';'||c2.EXTERNAL_ID ||';'|| c1.bill_ref_no ||';'|| c2.COMPONENT_ID ||';'|| c2.DISPLAY_VALUE ||'; Total='|| c2.total);
            null;
        end loop;        
