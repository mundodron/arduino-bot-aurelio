...
BEGIN
        FOR CC1 IN C_CONTAS_NO_BILL LOOP
            BEGIN
               UPDATE cdr_data SET NO_BILL = 1, ANNOTATION = 'CAMPANHAS ESPECIAIS' WHERE MSG_ID = CC1.MSG_ID AND MSG_ID2 = CC1.MSG_ID2 AND msg_id_serv = CC1.msg_id_serv and NO_BILL = 0;
               v_total:= v_total + 1;
