...
----------------------------------------------------------------------------------------------------
Versão: Autor:               DATA      DOC         PM/RDM       Motivo:
------  -------------------- --------- ----------- -----------  ------------------------------------
...
1.04    g0010388 Valter      16/07/12  RFC 363933               Melhorias na homologação.
...
1.06    g0010388 Valter      26/08/14  PROB609174  RDM9279      Mesmo não havendo registros ativos na tabela grc_motivos_arbor, a PL atualizava a tabela gvt_contestados_cobilling.
1.07    g0010388 Valter      18/09/14  PROB623211  RDM9657      Esta PL não estava buscando os Ajustes Massivos agrupados na tabela
...
1.09    g0010388 Valter      30/10/14  PROB713234  RDM12142     Adaptação ao Motivos cadastrados nas tabelas "grc_motivos_arbor" e "grc_motivos_de_para".
...
---------------------------------------------------------------------------------------------------- */
iUltima_RDM        varchar2(30) := 'RDM17134 (13/03/2015)';
...
------------------- ARQUIVO DE LOG
-------------------
--file_dir_log       varchar2(250) := '1';
--file_name_log      varchar2(250) := '2';
...
/* PORQUE FIZ A QUERY ASSIM? (valter 25/11/12), atualizado em (27/08/2014)
   ...
   1) GRC_SERVICOS_PRESTADOS
      Não dá para buscar pela GRC primeiro, pois nem todos os MSG_ID estão preenchidos na GRC, e resultaria num full table na CDR_DATA.
      E buscar na GRC por todas as chamadas... a assertividade seria menor.
   
   2) RANGE DE DATAS
      Não vou usar um Range de datas, pois ao buscar hoje (26/11/12) por chamadas que foram contestadas, haviam 37.000, e se todas mudarem o status
      para "RI" então na próxima execução, a quantidade será menor.
      E desta forma, estou garantindo que todas as chamadas que foram Contestadas serão pegas.
   
   3) REQUEST_STATUS
      Somente vou utiliza o request_status 1 e 4. Os outros são desnecessários.
    ...
    manual de ajuste - Kenan_BP_12_0-Guide_to_Products_Rates_and_Discounts.pdf
      REQUEST_STATUS = 6 (system generated reversal)
        ...
        Isto significa que um não existe um "request_status = 4" sem um "request_status = 6". Então não precisa validar o "request_status = 6".
*/
Cursor qADJ
  is
...
where hca.dt_ajuste > iULTIMA_EXECUCAO
  ...
  and cdr.msg_id2 = hca.msg_id2
    ...
    and grc.sequencial_chave = cdr.ext_tracking_id
    and grc.status  in ('F','A','R');

--÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷
-- Busca o lançamento de Contestação ocorrida antes do "Estorno de Contestação"
Cursor qEstorno is
  ...
  where orig_bill_ref_no     = r1x.orig_bill_ref_no
    ...
    and Exists ( -- Deve haver um lançamento de contestação no mesmo dia
                 Select 1
                   From GVT_CONTESTADOS_COBILLING gcc
                  Where gcc.adj_tracking_id      = adj.tracking_id
                    and gcc.adj_tracking_id_serv = adj.tracking_id_serv
...
--÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷
-- Busca na tabela "gvt_contestados_cobilling" por um lançamento de contestação.
...
BEGIN
  ...
  if iULTIMA_EXECUCAO is null then
     iULTIMA_EXECUCAO := sysdate-140;
  else
     iULTIMA_EXECUCAO := iULTIMA_EXECUCAO-70;
  end if;  
...
BEGIN
  ...
  -- Se o Índice for igual a zero, então popula a Nested Table
...
BEGIN
  ...
  LOOP
    ...
    IF radj.request_status = 4  THEN
      ...
      -- Para que possa haver um "cancelamento" de contestação, deve haver primeiro uma contestação no GRC.
      -- Esta rotina verifica se já foi enviado uma solicitacao de contestação (request_status = 1)
      
      -- Busca o "adj.transact_date"  na ADJ, onde o "request_status" = 1
      For rEstorno in qEstorno
      Loop
        -- Se existir registro na ADJ, Busca na tabela "gvt_contestados_cobilling" por um lançamento de contestação.
        Open  qCtr ( rEstorno.transact_date );
        Fetch qCtr into dummy;
           -- Se nao existir um lançamento de contestação, então permite que seja realizado um lançamento de Cancelamento da Contestação.
    ...
    ELSIF radj.request_status = 1 THEN
        ...
        ELSE
          ...
          --/*
          -- Se o status atual for igual a "R", então muda para "RP" (RECLAMADO APOS O REPASSE)
          -- Se o status atual for igual a "A", então muda para "RA" (RECLAMADO APOS A ARRECADACAO, ANTES DO REPASSE)
          -- Senão muda para "RI" (CONTESTADO)
          UPDATE grc_servicos_prestados
...
BEGIN
  ...
  LOOP
    ...
    -- No ajuste massivo não existe "Estorno de Ajuste"
