select * from customer_id_acct_map where external_id = '999984621784'

-- ultimas contas da Cardif
select account_no, bill_ref_no faturas from cmf_balance where account_no in (4353922) order by 2 desc
