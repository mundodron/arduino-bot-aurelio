select * from customer_id_acct_map where external_id = '999980003391' 
...
select * from bmf where account_no = 7382339 and bill_ref_no = 214209347 and BMF_TRANS_TYPE = -13