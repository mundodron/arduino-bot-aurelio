      SELECT DISTINCT t1.account_no,
                 ...
                 FROM service t3,
                      adj_trans_descr t2,
                      adj t1
                WHERE t1.orig_bill_ref_no in (select orig_bill_ref_no from g0023421sql.chamados_boleto)
        ...
        and     t4.orig_bill_ref_no in (select orig_bill_ref_no from g0023421sql.chamados_boleto)
        order by account_no,
                 orig_bill_ref_no,
