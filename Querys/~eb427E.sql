...
select account_no,quem, quando, old_no_bill, new_no_bill, old_remark, new_remark from gvt_log_cmf where account_no = 7715754 order by 3

select * from gvt_log_cmf where account_no = 8027969 order by 2
