...
-- 1.05    xxxxxxxxxxxxxxxxxxxx xxxxxxxxxx  xxxxxxxxxx  xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.
----------------------------------------------------------------------------------------------
  ...
  LOOP
    BEGIN
        ...
        ELSIF v_tipo_registro = '8' THEN
              ...
              v_realDuration       := RTRIM(LTRIM(SUBSTR(v_linha_arq,192,6)));
              v_billingPeriod      := RTRIM(LTRIM(SUBSTR(v_linha_arq,198,1)));
              v_degree             := RTRIM(LTRIM(SUBSTR(v_linha_arq,199,2)));
              v_visitedEOT         := RTRIM(LTRIM(SUBSTR(v_linha_arq,201,2)));
