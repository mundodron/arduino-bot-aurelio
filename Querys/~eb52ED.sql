SELECT   DISTINCT
       ...
       WHERE   SERVICE_ADDRESS_ASSOC.address_id = LOCAL_ADDRESS.address_id
               ...
               AND   service.parent_ACCOUNT_NO in (select account_no from customer_id_acct_map where external_id in ('999980674767'))
               
               AND   service.parent_ACCOUNT_NO in (select account_no from customer_id_acct_map where external_id in ('777777752092','777777752096','777777760729','777777763529','999979696307','999979696381','999979696940','999980674767','999984588981','999985332929','999986491618','999986492349','999986600869','999988685449','999989197581','999989197583','999989197584'))      
