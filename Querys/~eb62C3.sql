...
FROM CUSTOMER_ID_EQUIP_MAP EIEM,
     ...
     S_QUOTE_SOLN Q
WHERE service.parent_ACCOUNT_NO in (select account_no from customer_id_acct_map where external_id in ('999983795899'))
...
and   EIEM.EXTERNAL_ID like '%PROTECT%'
