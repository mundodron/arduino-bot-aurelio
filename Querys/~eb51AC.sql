      SELECT DISTINCT t1.account_no,
                ...
                WHERE t1.account_no = t3.parent_account_no
                  ...
                  AND t1.transact_date >= trunc(sysdate -30)
                  AND t1.transact_date < trunc(sysdate -2)
        ...
        order by account_no,
                 ...
                 select * from adj where transact_date < trunc(sysdate -2)
                 
                 select * from gvt_bankslip where DATA_ATUALIZACAO > trunc(sysdate -1)
