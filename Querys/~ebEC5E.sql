...
select x.ROW_ID, A.EXTERNAL_ID as CMF_EXT_ID, C.EXTERNAL_ID as EMF_EXT_ID, A.ACCOUNT_NO --, p.*
 ...
 where A.ACCOUNT_NO = S.PARENT_ACCOUNT_NO
   ...
   and A.EXTERNAL_ID = '777777765387'
   and X.X_ACCT_ID_NUM = A.EXTERNAL_ID
   and X.x_acct_id_num = '777777765387'
...
Insert into ARBORGVT_PAYMENTS.GVT_FEBRABAN_PONTA_B_ARBOR
  (ROW_ID,     CMF_EXT_ID, EMF_EXT_ID        , SERVICE_START                                          , DEGRAU, VELOCIDADE, UNID_VELOCIDADE,    CNLA,    CNLB,                ADDRESS_B, COMPL_B, DISTRICT_B)
Values
  ('3-JPTSLD', '777777765387', 'SPO-30JQ47I5-032', TO_DATE('01/31/2012 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 's/'  , 0, 'MB'   , '11000', '11000', 'AV         PAULISTA 2073',  'CJ Conjunto Nacional', 'SP');
