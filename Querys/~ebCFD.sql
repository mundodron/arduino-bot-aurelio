  SELECT   MAP.EXTERNAL_ID,
   ...
   WHERE   d.bill_ref_resets = 0
           ...
           AND MAP.EXTERNAL_ID = '999987529647';
           
           -- 21    3,390   15
           --select * from customer_id_acct_map where external_id = '999987529647'
           
           --select max(bill_ref_no) from bill_invoice where account_no = 3171697