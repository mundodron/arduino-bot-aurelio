      ...
      SELECT to_char(NULL),      to_char(NULL),    package_id,         to_number(NULL),                        type_code,
             ...
             billing_level,      billing_category, amount,             units,                                  tax,
      ...
      FROM   BILL_INVOICE_DETAIL b, CUSTOMER_ID_ACCT_MAP c, SERVICE s, CUSTOMER_ID_EQUIP_MAP m, PRODUCT_LINES p, DISCOUNT_DEFINITIONS d,
