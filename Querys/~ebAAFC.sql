...
SELECT B.ROW_ID,
  ...
  FROM S_QUOTE_SOLN A, 
       S_QUOTE_SOLN B 
 WHERE A.ASSET_NUM = 'SPO-3016P973R-16032-3016P973T'
...
WHERE  A.ROW_ID = B.QUOTE_SOLN_ID
  ...
  AND  A.ASSET_NUM = 'SPO-3016P973R-16032-3016P973T'
  AND  A.STATUS_CD = 'Ativo'
...
SELECT A.ROW_ID,G.X_TEXTO_LIVRE
 ...
 WHERE A.INV_ACCNT_ID = B.INV_ACCNT_ID
   ...
   AND A.ASSET_NUM = 'SPO-3016P973R-16032-3016P973T' --  instancia
   AND ROWNUM <= 1
 UNION
 SELECT A.ROW_ID,NULL AS PILOTO
   FROM S_QUOTE_SOLN A
  WHERE A.ASSET_NUM = 'SPO-3016P973R-16032-3016P973T' -- instancia
    AND A.STATUS_CD = 'Ativo'
...
select * from USAGE_POINTS where COUNTRY_CODE = 321
