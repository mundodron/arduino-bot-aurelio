...
FROM CUSTOMER_ID_EQUIP_MAP EIEM,
     ...
     S_QUOTE_SOLN Q
WHERE service.parent_ACCOUNT_NO in (select account_no from customer_id_acct_map where external_id in ('999987825899'))
...
AND   Q.ASSET_NUM in ('CTA-30NWLKKC-9699-30NWLKKL', 'FNB-30NWM8KO-9698')
and   Q.ROW_ID in ('3-1DGR44Y', '3-19VS7WP')
