update GVT_REL_ENCARGOS E set VALOR_ENCARGOS_FATURA_ATUAL = ( 
select sum(det.amount + det.federal_tax) "VALOR_FATURA_ATUAL"
 ...
 where inactive_date is null
   ...
   and MAP.EXTERNAL_ID = to_char(E.CONTA_COBRANCA)
