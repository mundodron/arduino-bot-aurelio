 SELECT D.EXTERNAL_ID, A.ACCOUNT_NO, B.BILL_REF_NO, A.VALOR, b.tracking_id, NSA
...
--                AND B.PAYMENT_DUE_DATE <= TO_DATE ('31/12/2011','DD/MM/YYYY')
                ...
                and D.EXTERNAL_ID = '999984807209'
                 ...
                 SELECT D.EXTERNAL_ID, A.ACCOUNT_NO, B.BILL_REF_NO, C.NEW_CHARGES VALOR, b.tracking_id FROM E9502359SQL.cancel_cef A,
                    PAYMENT_TRANS B,
                    CMF_BALANCE C,
                    CUSTOMER_ID_ACCT_MAP D
                WHERE  A.ACCOUNT_NO = B.ACCOUNT_NO
