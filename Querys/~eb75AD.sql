CREATE OR REPLACE TRIGGER "ARBORGVT_BILLING"."LOCAL_ADDRESS_UTRIG_GEOCODE" 
BEFORE UPDATE
OF franchise_tax_code,country_code,county,fx_geocode
ON ARBOR.LOCAL_ADDRESS FOR EACH ROW
DECLARE
...
ALTER TRIGGER "ARBORGVT_BILLING"."LOCAL_ADDRESS_UTRIG_GEOCODE" ENABLE