select * from GVT_FEBRABAN_PONTA_B_ARBOR where CMF_EXT_ID = '999982223746'
...
WHERE service.parent_ACCOUNT_NO in (select account_no from customer_id_acct_map where external_id in ('999982223746'))
